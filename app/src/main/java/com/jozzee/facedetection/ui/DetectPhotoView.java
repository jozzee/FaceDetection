package com.jozzee.facedetection.ui;
...
/**
 * Created by Sitthiphong on 1/19/2017 AD.
 */
 ...
 */
public class DetectPhotoView extends View {
    private Bitmap mBitmap;
    private SparseArray<Face> mFaces;

    public DetectPhotoView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
